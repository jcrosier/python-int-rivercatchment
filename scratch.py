...
site_geometry = gpd.points_from_xy(site_locations['Longitude'], site_locations['Latitude'], crs='EPSG:4326')
...
print(is_site_within_catchment(site_gdf.loc[['TE03']], FP_catchment))
